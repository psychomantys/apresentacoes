...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \makebox[\textwidth]{\includegraphics[width=\textwidth]{./figuras/visao_geral_tempo.pdf}}
%    \makebox[\textheight]{\includegraphics[height=\textheight]{./figuras/visao_geral_tempo.pdf}}
  \end{figure}
\end{frame}
...
%  \frametitle{Releases}
  \begin{figure}
    \centering
    \makebox[\textwidth]{\includegraphics[width=\textwidth]{./figuras/ciclo_release.pdf}}
  \end{figure}
  \begin{itemize}%[<+->]
...
\begin{frame}
  \begin{figure}
    \centering
    \makebox[\textwidth]{\includegraphics[width=\paperwidth]{./figuras/ciclo_iteracoes.pdf}}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \makebox[\textwidth]{\includegraphics[width=\textwidth]{./figuras/ciclo_geral_tarefas.pdf}}
  \end{figure}
\end{frame}
